...
static const char *fonts[] = { "JetBrainsMono NFP Medium:size=14", "Noto Color Emoji:size=13", "CoconNextArabic-Light:size=13" };
...
/* tagging */
static const char *tags[] = {"", "",  "",  "", "", "ﯙ", "󰮤", "󱍑", "󰒱"};
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_teal, "-sf", col_gray4, NULL };
